...
US_ETFS = [
    ...
    ("VEA", "ftse_dev_world"), ("VWO", "msci_em"), ("IEMG", "msci_em_imi"),
    ("EFA", "msci_world"), ("URTH", "msci_world"),
    ("IWM", "russell2000"), ("IJR", "sp_smallcap600"),
    ("SCHD", "us_dividend_growers"), ("VYM", "us_dividend_growers"),
    ("VIG", "us_dividend_growers"), ("NOBL", "us_dividend_growers"),
